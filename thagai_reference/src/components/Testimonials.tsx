...
export function Testimonials() {
  return (
    <section id="testimonials" className="py-24 bg-gradient-to-b from-cream-dark via-cream to-cream-dark relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-burgundy/5 rounded-full blur-[100px] -translate-y-1/2 -translate-x-1/4 pointer-events-none"></div>
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-teal/5 rounded-full blur-[100px] translate-y-1/2 translate-x-1/4 pointer-events-none"></div>

      {/* Decorative Floating Icons */}
      <div className="absolute top-24 left-[5%] opacity-15 animate-float pointer-events-none">
      ...
      <div className="absolute bottom-32 right-[8%] opacity-20 animate-float-delayed pointer-events-none">
        <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-teal">
          <circle cx="12" cy="12" r="10" strokeWidth="0.5" />
        </svg>
      </div>
      <div className="absolute top-1/2 left-[50%] w-3 h-3 bg-gold/20 rounded-full animate-float pointer-events-none"></div>

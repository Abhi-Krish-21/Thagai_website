...
export function ContactSection() {
  return (
    <section
      id="contact"
      className="pt-24 pb-80 bg-burgundy text-white relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-b from-transparent to-cream pointer-events-none z-0"></div>
    </section>);
